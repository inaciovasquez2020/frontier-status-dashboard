# Restricted Wellposedness Interface — 2026-05-22

Status: `WELLPOSEDNESS_INTERFACE_ONLY_THEOREM_NOT_PROVED`

Supplied object: `RESTRICTED_WELLPOSEDNESS_INTERFACE`

## Purpose

This supplies the restricted wellposedness interface required after `RESTRICTED_ENERGY_CONDITION_INTERFACE`.
...
- `declared_restricted_gate_predicates`
...
- `unrestricted_wellposedness_claim`
